...
function(_install_python LIBRARY_NAME)
    ...
    get_filename_component(package_prefix ${PXR_PREFIX} DIRECTORY)

    set(files_copied "")
    foreach(file ${ip_FILES})
        set(filesToInstall "")
        set(installDest
            "${libPythonPrefix}/${package_prefix}/${LIBRARY_INSTALLNAME}")
...
function(_install_pyside_ui_files LIBRARY_NAME)
    ...
    install(
        FILES ${uiFiles}
        DESTINATION "${libPythonPrefix}/${package_prefix}/${LIBRARY_INSTALLNAME}"
    )
...
function(_pxr_python_module NAME)
    ...
    get_filename_component(package_prefix ${PXR_PREFIX} DIRECTORY)
    set(libInstallPrefix "lib/python/${package_prefix}/${pyModuleName}")
